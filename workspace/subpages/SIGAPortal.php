...
<head>
    ...
    <script src="jsQueries/getCatequistas.js"></script>
    <script src="jsQueries/getCoordinadores.js"></script>
    <script src="jsQueries/getGrupos.js"></script>
</head>
                    ...
                    <div data-bs-parent="#panelG">
                            ...
                            <div class="container">
                                ...
                                <div class="row align-items-center justify-content-center">
                                    <div class="col-auto">
                                        <div class="alert alert-info alert-dismissible fade show" role="alert">
                                            ...
                                            A continuación, por favor, ingrese primer apellido, cédula del coordinador o seleccione la parroquia a la que pertenece el coordinador!
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center justify-content-center">
                                    <form id="getCoordinadoresAdmin" class="row justify-content-center">
                                        ...
                                        <div class="col-2">
                                            <input id="cedulaCatequista" name="cedulaCatequista" type="text" class="form-control" placeholder="C.C. del Coordinador">
                                        </div>
                                        <div class="col-4">
                                            <select class="form-select" aria-label="selectParroquia" name="parroquia" id="parroquia">
                                        ...
                                        <div class="col-3">
                                            <button type="button" class="btn btn-success" onclick="consultaCoordinadorAdmin();">Buscar</button>
                                            <button type="button" class="btn btn-secondary" onclick="getCoordinadoresAdmin.reset();cleanCoordinadores();">Limpiar</button>
                                            <a role="button" class="btn btn-primary" target="_blank" href="administracion/newCatequistas.php?a!¡v02ds3ass334de$?!!=1" onclick="window.open(this.href, this.target, 'width=650,height=560'); return false;">Añadir</a>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="collapse multi-collapse" data-bs-parent="#panelG" id="adminGrupos">
                            <div class="container">
                                ...
                                <div class="row align-items-center justify-content-center">
                                    <div class="col-auto">
                                        <div class="alert alert-info alert-dismissible fade show" role="alert">
                                            ...
                                            A continuación, por favor, seleccione la parroquia a la que pertenece el grupo!
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center justify-content-center">
                                    <form id="getGruposAdmin" class="row justify-content-center">
                                        <div class="col-4">
                                            <select class="form-select" aria-label="selectParroquia" name="parroquia" id="parroquia">
                                        ...
                                        <div class="col-3">
                                            <button type="button" class="btn btn-success" onclick="consultaGruposAdmin();">Buscar</button>
                                            <button type="button" class="btn btn-secondary" onclick="getGruposAdmin.reset();cleanGrupos();">Limpiar</button>
                                            <a role="button" class="btn btn-primary" target="_blank" href="administracion/newGrupos.php?a!¡v02ds3ass334de$?!!=1" onclick="window.open(this.href, this.target, 'width=650,height=280'); return false;">Añadir</a>
                                        </div>
                                    </form>
                                </div>

                                <div class="row align-items-center justify-content-center" id="consultaGruposAdminPane">
