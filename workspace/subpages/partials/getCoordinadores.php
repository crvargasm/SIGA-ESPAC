...
try {
    ...
    if (vacio($apellidoCatequista) && vacio($cedulaCatequista) && $parroquia == 0) {  //Verifica que NO este Vacia La Consulta
        ...
        if (!vacio($apellidoCatequista) && vacio($cedulaCatequista) && $parroquia == 0) {  //Verifica SOLO Primer Apellido
            $result = $conn->query("SELECT * FROM infoCatequista WHERE (apellidoCatequista LIKE '$apellidoCatequista%' OR apellido2Catequista LIKE '$apellidoCatequista%') AND coordinadorHabilitar = 1");
        }
        if (vacio($apellidoCatequista) && !vacio($cedulaCatequista) && $parroquia == 0) {  //Verifica SOLO ID del Catequista
            $result = $conn->query("SELECT * FROM infoCatequista WHERE cedulaCiudadania='$cedulaCatequista' AND coordinadorHabilitar = 1;");
        }
        if (vacio($apellidoCatequista) && vacio($cedulaCatequista) && $parroquia != 0) {  //Verfica SOLO Parroquia Catequista
            $result = $conn->query("SELECT * FROM infoCatequista WHERE parroquiaCatequista='$parroquia' AND coordinadorHabilitar = 1;");
        }
        if (!vacio($apellidoCatequista) && !vacio($cedulaCatequista) && $parroquia == 0) { //Verifica Primer Apellido y ID
            $result = $conn->query("SELECT * FROM infoCatequista WHERE cedulaCiudadania='$cedulaCatequista' AND (apellidoCatequista LIKE '$apellidoCatequista%' OR apellido2Catequista LIKE '$apellidoCatequista%') AND coordinadorHabilitar = 1");
        }
        if (vacio($apellidoCatequista) && !vacio($cedulaCatequista) && $parroquia != 0) { //Verifica ID y Parroquia
            $result = $conn->query("SELECT * FROM infoCatequista WHERE cedulaCiudadania='$cedulaCatequista' AND parroquiaCatequista='$parroquia' AND coordinadorHabilitar = 1");
        }
        if (!vacio($apellidoCatequista) && vacio($cedulaCatequista) && $parroquia != 0) {  //Verifica Primer Apellido y Parroquia
            $result = $conn->query("SELECT * FROM infoCatequista WHERE parroquiaCatequista='$parroquia' AND (apellidoCatequista LIKE '$apellidoCatequista%' OR apellido2Catequista LIKE '$apellidoCatequista%') AND coordinadorHabilitar = 1;");
        }
        if (!vacio($apellidoCatequista) && !vacio($cedulaCatequista) && $parroquia != 0) {  //Verifica TODOS
            $result = $conn->query("SELECT * FROM infoCatequista WHERE cedulaCiudadania='$cedulaCatequista' AND parroquiaCatequista='$parroquia' AND (apellidoCatequista LIKE '$apellidoCatequista%' OR apellido2Catequista LIKE '$apellidoCatequista%') AND coordinadorHabilitar = 1;");
        }
    }
